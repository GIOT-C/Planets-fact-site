...
import "../NewApp.css";
import styles from "./VenusPage.module.css";
...
function VenusPage() {
  const planetData = UsePlanetData("Venus");
      ...
      <div className="parentBodyContainer">
        <div className="bodyContainer">
          <div className="planetImgContainer">
            <img
              className={styles.venusImg}
              src={changeInfo === "structure" ? venusInternalImg : venusImg}
              alt="venus"
            />
            ...
            {changeInfo === "geology" ? (
              <img
                ...
                src={changeInfo === "geology" ? geologyVenus : ""}
                alt="geology-venus"
              />
            ) : (
              ""
          ...
          <div className="planetInfoContainer">
            <div className="info">
              <h1 className="planetName">
                {planetData?.name.toUpperCase() || "Venus"}
              </h1>
