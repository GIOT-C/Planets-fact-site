...
import "../NewApp.css";
import styles from "./JupiterPage.module.css";
...
function JupiterPage() {
  const planetData = UsePlanetData("Jupiter");
      ...
      <div className="parentBodyContainer">
        <div className="bodyContainer">
          <div className="planetImgContainer">
            <img
              className={styles.jupiterImg}
              src={changeInfo === "structure" ? jupiterInternalImg : jupiterImg}
              alt="jupiter"
            />
            ...
            {changeInfo === "geology" ? (
              <img
                ...
                src={changeInfo === "geology" ? geologyJupiter : ""}
                alt="geology-jupiter"
              />
            ) : (
              ""
          ...
          <div className="planetInfoContainer">
            <div className="info">
              <h1 className="planetName">
                {planetData?.name.toUpperCase() || "Jupiter"}
              </h1>
