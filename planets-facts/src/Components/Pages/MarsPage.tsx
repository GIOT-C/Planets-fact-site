...
function MarsPage() {
  const planetData = UsePlanetData("Mars");
      ...
      <div className="parentBodyContainer">
        <div className="bodyContainer">
          <div className="planetImgContainer">
            <img
              className={styles.marsImg}
              src={changeInfo === "structure" ? marsInternalImg : marsImg}
              alt="mars"
            />
            ...
            {changeInfo === "geology" ? (
              <img
                ...
                src={changeInfo === "geology" ? geologyMars : ""}
                alt="geology-mars"
              />
            ) : (
              ""
          ...
          <div className="planetInfoContainer">
            <div className="info">
              <h1 className="planetName">
                {planetData?.name.toUpperCase() || "Mars"}
              </h1>
